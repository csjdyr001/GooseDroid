...
public class GlobalApplication extends Application {
    ...
    public void onCreate() {
		...
		KeepLive.INSTANCE.init(new Intent(this, (Class<?>) MainActivity.class));
		KeepLive.INSTANCE.setCheckStart(false);
    }
                            ...
                            MAIN_HANDLER.post(new Runnable(){
                                    ...
                                    public void run() {
										...
										AlertDialog dialog = new AlertDialog.Builder(mContext)
											.setTitle("异常-" + e.getClass().getName())
											.setMessage("内容")
											...
											.setNegativeButton(android.R.string.copy, new DialogInterface.OnClickListener() {
												...
												public void onClick(DialogInterface dia, int which) {
													...
													ClipData myClip = ClipData.newPlainText("text", e.toString());

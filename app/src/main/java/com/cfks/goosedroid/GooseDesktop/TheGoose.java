...
public class TheGoose {
  ...
  private static class Task_CollectWindow {
    ...
    public TheGoose.Task_CollectWindow.Stage stage = TheGoose.Task_CollectWindow.Stage.WalkingOffscreen;
  ...
  private static class Task_TrackMud {
    ...
    public TheGoose.Task_TrackMud.Stage stage = TheGoose.Task_TrackMud.Stage.DecideToRun;
